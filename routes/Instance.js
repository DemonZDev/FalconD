...
router.get('/:id', (req, res) => {
  ...
  const instanceId = req.params.id; // Tracking via instance ID now
...
router.get('/:id/delete', async (req, res) => {
  ...
  const instanceId = req.params.id; // Tracking via instance ID now
    ...
    try {
        ...
        console.error(`Error deleting instance ${instanceId}:`, err.message);
...
router.get('/purge/all', async (req, res) => {
  try {
    const containers = await // List running processes instead of Docker containers
